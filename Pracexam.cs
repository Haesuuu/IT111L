...
namespace Assessment3Exer
{
    class Voter
    {
        // Use auto-properties (no separate private backing fields needed)
    ...
    class VotersRegistry
    {
        ...
        public void AddVoter()
        {
            ...
            string name = GetString("Name"); //validated thru methods
            ...
            Voter v = new Voter(id, name, gender, age, baranggaycode, municipalitycode); //CREATE STUDENT OBJECT
    ...
    //MAIN PROGRAM FOR CONSOLE CHUCHU---------------------------------------------------
